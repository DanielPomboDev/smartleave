<x-layouts.layout>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="card bg-white shadow-md lg:col-span-2" id="password">
            <div class="card-body">
                <h2 class="card-title text-xl font-bold text-gray-800 mb-6">
                ...
                <form class="space-y-6">
                    <div class="form-control">
                        ...
                        <div class="relative">
                            <input type="password" class="input input-bordered w-full pr-10" id="currentPassword" placeholder="Enter your current password">
                            <button type="button" class="absolute inset-y-0 right-0 px-3 flex items-center" onclick="togglePasswordVisibility('currentPassword')">
